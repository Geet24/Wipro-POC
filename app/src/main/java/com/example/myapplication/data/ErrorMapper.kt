...
import com.example.myapplication.common.utils.JsonUtils
import com.example.myapplication.data.sources.api.model.response.ErrorResponse
...
private fun mapErrorCode(code: Int, message: String? = null): AppError {
    return when (code) {
        ...
        401 -> AppError(code = ErrorCodes.HTTP_UNAUTHORISED, message = message)
